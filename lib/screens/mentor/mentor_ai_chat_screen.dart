...
class _MentorAiChatScreenState extends State<MentorAiChatScreen> {
  ...
  static const List<Map<String, dynamic>> _quickActions = [
    {
      ...
      'prompt': 'Give me a summary of how my students are performing overall.'
    },
    {
      'emoji': '⚠️',
      'label': 'At-Risk Students',
      'prompt':
          'Which students might be at risk based on low engagement or issues?'
    },
    {
      'emoji': '✉️',
      'label': 'Warning Email',
      'prompt':
          'Draft a professional attendance warning email for a struggling student.'
    },
    {
      'emoji': '📅',
      'label': 'Academic Calendar',
      'prompt':
          'What are the key academic events and deadlines I should track this semester?'
    },
    {
      'emoji': '💡',
      'label': 'Intervention Tips',
      'prompt':
          'What are the best intervention strategies for a student with declining marks?'
    },
    {
      'emoji': '🎯',
      'label': 'Career Guidance',
      'prompt':
          'How can I help my B.Tech students with career planning and placements?'
    },
    {
      'emoji': '🧠',
      'label': 'Student Stress',
      'prompt':
          'How do I support a student who is showing signs of stress or anxiety?'
    },
    {
      'emoji': '📋',
      'label': 'Class Report',
      'prompt':
          'Create a structured template for a monthly class progress report.'
    },
    {
      'emoji': '🏛️',
      'label': 'College Policy',
      'prompt':
          'What are the standard procedures for academic disciplinary actions?'
    },
    {
      'emoji': '👨‍👩‍👧',
      'label': 'Parent Meeting',
      'prompt':
          'How should I prepare for a parent-teacher meeting about a student\'s performance?'
    },
  ];
  ...
  Future<void> _greet() async {
    ...
    final name = auth.currentUser?.name.trim().isNotEmpty == true
  ...
  Future<void> _send([String? quick]) async {
    ...
    setState(() {
      _msgs.add(_Msg(role: 'user', content: text));
      _isTyping = true;
    });
    _scrollToBottom();
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color:
                                    AppTheme.mentorBubble.withOpacity(0.25))),
                    ...
                    decoration: BoxDecoration(
                        ...
                        boxShadow: _isTyping
                            ...
                            : [
                                BoxShadow(
                                    color:
                                        AppTheme.mentorBubble.withOpacity(0.35),
                                    blurRadius: 8,
